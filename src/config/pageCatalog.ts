...
const MOBILE_H5_CATALOG: PageCatalogItem[] = [
  ...
  { id: 'mobile-mine-account-security', platform: 'mobile', routeName: 'mobile-mine-account-security', path: '/mobile/mine/settings/account-security', title: '账号与安全', group: '我的', pagePath: ['移动端', '我的', '设置', '账号与安全'] },
