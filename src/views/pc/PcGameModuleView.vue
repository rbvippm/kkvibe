...
import { GAME_MODULE_ANNOT_MAP } from '../../constants/gameModuleSpec'
...
const filterAnnot = GAME_MODULE_ANNOT_MAP.filter
const addAnnot = GAME_MODULE_ANNOT_MAP.addButton
const listAnnot = GAME_MODULE_ANNOT_MAP.list
const modalAnnot = GAME_MODULE_ANNOT_MAP.modal
const channelAuthAnnot = GAME_MODULE_ANNOT_MAP.channelAuth
  ...
  <div class="pc-wireframe-page">
    ...
    <section class="wf-block">
      ...
      <div class="wf-toolbar wf-toolbar--filters">
        <label class="wf-label wf-label--with-spec" for="gm-filter-channel">
          渠道：
          <WfSpecAnnot
            :no="filterAnnot.no"
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <div class="wf-modal__header">
            <h3 id="gm-auth-title" class="wf-modal__title wf-modal__title--with-spec">
              授权渠道
              <WfSpecAnnot
