...
const props = withDefaults(
  defineProps<{
    embedded?: boolean
    showCollapseHandle?: boolean
  }>(),
  { embedded: false, showCollapseHandle: false },
)
...
<template>
  <div class="mh5-vip-sports-page" :class="{ 'mh5-vip-sports-page--embed': embedded }">
    <header class="mh5-vip-sports-header">
      <button type="button" class="mh5-vip-sports-header__brand" aria-label="金刚体育" @click="onBrandClick">
