...
export const AGENT_MY_SHARE_RATIO_SPEC: MobilePrdSpec = {
  ...
  sections: buildMobilePrdSections({
    logic: [
      '代理在概况页点击「占成比例」后，以居中弹框查看本人各游戏类型与成本类型占成（只读），用于了解当前分成配置。',
      '弹框上下两张表：游戏类型 / 占成比例，成本类型 / 占成比例；不提供编辑；确认后关闭弹框留在概况。',
    ],
    interaction: [
      '入口：代理中心概况 → 账号卡「占成比例」。',
    ...
    visual: [
      ...
      '居中白底圆角卡：内嵌两张圆角表格（间距约 12px），表头浅橙渐变；上表列「游戏类型 / 占成比例」，下表列「成本类型 / 占成比例」。',
      '表体白底行，浅灰分隔线；类型左对齐，比例右对齐；内容区可纵向滚动。',
      '卡片底部橙色渐变「确定」按钮（圆角）。',
    ],
    data: [
      '游戏类型顺序与数值以产品配置为准；原型 Mock：刮刮乐 2.5%、棋牌 1.8%、弹珠 1.5%、彩票 1.3%、趣投 1.1%、体育 0.9%、真人 0.8%、老虎机 0.6%、捕鱼 0.5%。',
      '成本类型（VIP晋级礼金、活动金）共用同一占成比例；原型 Mock：1.0%。',
      '占成比例展示为带百分号的小数文案。',
    ],
    exception: [
