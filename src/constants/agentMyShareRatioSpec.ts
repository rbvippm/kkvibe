...
export const AGENT_MY_SHARE_RATIO_SPEC: MobilePrdSpec = {
  ...
  sections: buildMobilePrdSections({
    logic: [
      ...
      '返佣代理：概况页点「返佣比例」后，以居中弹框查看直属佣金与下级额外佣金比例（只读）。',
      '占成弹框：占成类型 / 占成比例；原 VIP晋级礼金、VIP额外奖金与活动金合并为「其他成本」置于表末；不提供编辑。',
      '返佣弹框：代理 / 返佣比例；行为直属佣金、下一级额外佣金、下二级额外佣金；不提供编辑；确认后关闭弹框留在概况。',
    ],
    interaction: [
      '入口：代理中心概况 → 账号卡「占成比例」或「返佣比例」（随身份切换文案）。',
      '弹出后背景概况页半透明遮罩 + 模糊；点击「确定」或遮罩关闭弹框。',
    ],
    visual: [
      '遮罩：黑色 25% 透明 + 模糊，盖住概况页。',
      '居中白底圆角卡：内嵌一张圆角表格，表头浅橙渐变；占成列「占成类型 / 占成比例」，返佣列「代理 / 返佣比例」。',
    ...
    data: [
      ...
      '返佣比例原型 Mock：直属佣金 10%、下一级额外佣金 5%、下二级额外佣金 2.5%。',
      '比例展示为带百分号的文案。',
    ],
    exception: [
      '无配置数据时表格展示空态「暂无占成比例」或「暂无返佣比例」；原型阶段始终有 Mock 行。',
      '重复点击「确定」仅关闭弹框，不跳转。',
    ],
    routing: [
