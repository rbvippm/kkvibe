...
export const CHAT_GALLERY_ALBUMS: GalleryAlbum[] = [
  { id: 'recents', name: '最近项目', cover: M[0], count: 14 },
...
export const CHAT_GALLERY_ITEMS: GalleryMediaItem[] = [
  ...
  { id: 'g3', src: M[2], type: 'video', duration: '0:04', sizeLabel: '983 KB', sizeBytes: 1_006_592, albumId: 'recents' },
  ...
  { id: 'g9', src: M[4], type: 'video', duration: '0:12', sizeLabel: '2.1 MB', sizeBytes: 2_202_010, albumId: 'camera' },
